...
%% \caption{Histogram depicting approximative per-invocation profilation and percentage of density distribution of 1000 magic instructions in milliseconds.}
%% \label{fig:histogramfoveated}
%% \end{figure}
