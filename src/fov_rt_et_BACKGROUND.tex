...
% One limitation is rays resolution, since rays must, on an individual basis, perform intersection tests on possibly large amounts of geometry.
% Although acceleration methodologies may lessen this load, this may still pose an issue to high-resolution displays, such as the emerging 4k.
